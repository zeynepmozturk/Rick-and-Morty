...
import 'package:rickandmorty/models/episode_model.dart'; // EpisodesModel burada
import 'package:rickandmorty/services/api_service.dart';

class SectionsViewmodel extends ChangeNotifier {
  final _apiService = locator<ApiService>();

  EpisodesModel? _episodesModel; // EpisodesModel olarak değiştir
  EpisodesModel? get episodesModel => _episodesModel;

  void getEpisodes() async {
    _episodesModel = await _apiService.getAllEpisodes(); // Artık uyumlu
    notifyListeners();
  }
